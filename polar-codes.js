...
const CONTROL_POINT_REQUEST = {
    GET_ACC_STREAM_SETTINGS: Uint8Array.of(0x01, MEASUREMENT_TYPE.ACC),
    GET_ECG_STREAM_SETTINGS: Uint8Array.of(0x01, MEASUREMENT_TYPE.ECG),
    ...
    // Uint8Array.of(0x02, 0x02, 0x02, 0x01, 0x08, 0x00, 0x00, 0x01, 0xC8, 0x00, 0x01, 0x01, 0x10, 0x00);
